...
def login(request):
    """! Logs the user in and returns the list of folders.
...
def register(request):
    """! Registers a new user and returns the login page.
    @param request HttpRequest Object.
    @return HttpResponse Object.
    """
    if request.method == 'POST':
...
@login_required
def folders(request):
    """! Returns list of user's folders.
    @param request HttpRequest Object.
    @return HttpResponse Object.
    """
...
def new_folder2(request):
	"""! Adds a new folder and returns Updated list of user's folders with the new folder added.
    @param request HttpRequest Object.
    @return HttpResponse Object.
    """
	if request.method!='POST':
...
def edit_folder(request,folder_id):
	"""! Edits name and language of an existing folder and returns Updated list of folders with edited folder name and/or language.
    @param request HttpRequest Object.
    @param folder_id Id of the folder to be edited.
    @return HttpResponse Object.
    """
	folder = Folder.objects.get(id=folder_id)
	check_folder_owner(request,folder)
...
def delete_folder(request, folder_id):
    """! Deletes an existing folder ans returns Updated list of folders with the concerned folder deleted.
    @param request HttpRequest Object.
...
def delete_file(request, file_id):
    """! Deletes an existing file from the folder and returns Updated list of files with the concerned file deleted.
    @param request HttpRequest Object.
